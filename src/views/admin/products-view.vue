								...
								<td class="px-6 py-4 whitespace-nowrap">
									<div class="flex items-center">
										...
										<div class="ml-4">
											...
											<div class="text-sm text-gray-500">SKU: SAMPLE-001</div>
										</div>
									</div>
								</td>
								<td class="px-6 py-4 text-sm whitespace-nowrap text-gray-900">Clothing</td>
								<td class="px-6 py-4 text-sm whitespace-nowrap text-gray-900">$99.99</td>
								<td class="px-6 py-4 text-sm whitespace-nowrap text-gray-900">50</td>
								<td class="px-6 py-4 whitespace-nowrap">
									<span
